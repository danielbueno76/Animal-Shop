function activarPrimerControl(){ //Acciones tras cargar la página
...
//mostramos la calculadora haciendo que el elemento visibility se ponga visible si esta escondida la calculadora, 
//pero si ya esta mostrada se queda como esta.
function mostrarCalculadora(){
	calcu=document.getElementById("calculadora");
	if(calcu.style.visibility="hidden"){
	calcu.style.visibility="visible";
	calcu.style.position="relative";
	}
	else {calcu.style.visibility="hidden";}
	
}

//hacemos desaparecer la calculadora haciendo que el elemento visibility se ponga hidden si esta visible la calculadora, 
//pero si ya esta escondida se queda como esta.
function desaparecercalculadora(){
	calcu=document.getElementById("calculadora");
	if(calcu.style.visibility="visible"){
	calcu.style.visibility="hidden";
	calcu.style.position="absolute";
	}
	else {calcu.style.visibility="visible";}
}

//mostrar número en pantalla según se va escribiendo:
function numero(xx) { //recoge el número pulsado en el argumento.
         if (x=="0" || xi==1  ) {	// inicializar un número, 
            pantalla.innerHTML=xx; //mostrar en pantalla (innerHTML sirve para "escribir" dentro de un elemento HTML)
            x=xx; //guardar número
